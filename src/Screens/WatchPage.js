      ...
      <div className="container mx-auto bg-dry p-6 mb-12">
        <div className="flex-btn flex-wrap mb-6 gap-2 bg-main rounded border border-gray-800 p-6">
          ...
          <div className="flex-btn sm:w-auto w-full gap-5">
            ...
            <button className="bg-subMain flex-rows gap-2 flex hover:text-main transitions  text-white rounded px-8 font-medium py-3 text-sm">
          ...
          <div className="w-full rounded-lg overflow-hidden relative">
            <div className="absolute top-0 left-0 bottom-0 right-0 bg-main bg-opacity-30 flex flex-colo">
              <button
                ...
                className="bg-white text-subMain flex flex-colo border border-subMain rounded-full w-20 h-20 font-medium text-xl"
              >
                <FaPlay />
              </button>
            </div>
