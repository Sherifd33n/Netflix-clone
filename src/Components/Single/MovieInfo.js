  ...
  return (
    <div className="w-full xl:h-screen relative text-white">
      ...
      <div className="xl:bg-main bg-dry flex-colo xl:bg-opacity-90 xl:absolute top-0 left-0 right-0 bottom-0">
        <div className="container px-3 mx-auto xl:grid grid-cols-3 flex-colo py-10 lg:py-20 gap-8">
          <div className="xl:col-span-1 w-full xl:order-none order-last h-[470px] bg-dry border border-gray-800 rounded-lg overflow-hidden">
            <img
          ...
          <div className="col-span-2 md:grid grid-cols-5 gap-4 items-center">
            <div className="col-span-3 flex flex-col gap-10">
              <h1 className="xl:text-3xl capitalize font-sans text-2xl font-bold">
                {movie?.name}
              </h1>
              ...
              <div className="grid sm:grid-cols-5 grid-cols-3 gap-4 p-3 bg-main border border-gray-800 rounded-lg">
                ...
                <div className="sm:col-span-2 col-span-3 flex justify-end font-medium text-sm">
                  <Link
                    to={`/watch/${movie?.name}`}
                    className="bg-dry py-3 hover:bg-subMain transitions border-2 border-subMain rounded-full flex flex-rows gap-4 w-full sm:py-3"
                  >
